    ...
    <body>
   	...
   	<div class="content">
		...
		<div class="text">
   			<h2>AVISO LEGAL</h2>
   			<p>
                Beta  a través de su sitio web concede una licencia para que los usuarios utilicen  los productos que son vendidos en este sitio web de acuerdo a los Términos y Condiciones que se describen en este documento.
            </p>
            <p>
            ...
            <p>
                Beta reserva los derechos de cambiar o de modificar estos términos sin previo aviso. En el caso de productos que sean  mercancías irrevocables no-tangibles, no realizamos reembolsos después de que se envíe el producto, usted tiene la responsabilidad de entender antes de comprarlo.  Le pedimos que lea cuidadosamente antes de comprarlo. Hacemos solamente excepciones con esta regla cuando la descripción no se ajusta al producto.
            </p>
   		</div>
   		...
   		<div class="image">
   			<img src="../img/aviso_legal.png" alt="" width="500px">
   		</div>
